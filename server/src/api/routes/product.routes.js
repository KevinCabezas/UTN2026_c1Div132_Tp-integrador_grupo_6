...
import { createProduct, getAllProducts, getProductById, modifyProduct, removeProduct, getProductStockById, activateProduct, getProductByIdAdmin  } from "../controllers/product.controllers.js";
...
// UPDATE product
router.put("/", requireLogin, upload.single("image"),validateProduct, modifyProduct);
// DELETE product
