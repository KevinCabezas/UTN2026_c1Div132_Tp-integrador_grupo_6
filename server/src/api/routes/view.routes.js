...
import { indexView, loginView, listProductsView,consultProductView,createProductView,updateProductView,deleteProductView,activateProductView,createAdminView  } from "../controllers/view.controllers.js";
...
router.get("/dashboard/activar", requireLogin, activateProductView);
